...
body.push(key+'='+encodeURIComponent(params[key]));return url.split('?').shift()+'?'+body.join('&');}},bind:function(input,data){if(typeof data=='string')
data=[data];if(typeof input=='string'&&typeof data=='object'){for(var key in data){if(data instanceof Array)
input=input.replace(new RegExp(':[a-zA-Z0-9_]+'),data[key]);else
...
this._connection.setRequestHeader('Content-type',this._data.content_type);this._connection.send(data);return this;};this.setContentType=function(contentType){this._data.content_type=contentType;return this;};this.setEndpoint=function(endpoint,params){this._data.endpoint=endpoint;if(typeof params=='object')
...
this._proxy=ChangeOrgApiUtils.proxy;};var ChangeOrgApiRequest=function(client){this._authKey=null;this._data={};this._connection=null;this._useSignature=true;this._useAuthKeyInSignature=true;this._getDefaults=function(){return{api_key:'',endpoint:'',timestamp:''};};this.addClient=function(){this._data.api_key=this._client.getApiKey();return this;};this.addData=function(data){if(typeof this._data=='object'){for(var key in data)
this._data[key]=data[key];}
return this;};this.addSignature=function(){try{if(typeof this._data.rsig=='undefined'||!this._data.rsig.length){var body=[],signature='';for(var key in this._data){if(key!='rsig')
...
return this._data[key];return null;};this.getEndpoint=function(){return this._data.endpoint;};this.getMethod=function(){return this.getConnection().getMethod();};this.getSignatureAuthKeyRequiredFlag=function(){return this._useAuthKeyInSignature;};this.getSignatureRequiredFlag=function(){return this._useSignature;};this.getTimestamp=function(){return this._data.timestamp;};this.newTimestamp=function(){return(new Date()).toISOString().replace(/(\.[0-9]+)/,'');};this.send=function(){var connection=this.getConnection();connection.setEndpoint(this._data.endpoint);this.getConnection().send(this.buildRequest());return this;};this.setAuthKey=function(authKey){this._authKey=authKey;return this;};this.setData=function(key,value){this._data[key]=value;return this;};this.setEndpoint=function(endpoint){this._data.endpoint=endpoint;return this;};this.setClient=function(client){if(!(client instanceof ChangeOrgApiClient))
throw new ChangeOrgApiException('Client must be an instance of ChangeOrgApiClient.');this._client=client;return this;};this.setMethod=function(method){this.getConnection().setMethod(method);return this;};this.setOnSuccess=function(handler){this.getConnection().setOnSuccess(handler);return this;};this.setSignatureAuthKeyRequiredFlag=function(bool){this._useAuthKeyInSignature=bool;return this;};this.setSignatureRequiredFlag=function(bool){this._useSignature=bool;return this;};this.setTimestamp=function(timestamp){this._data.timestamp=timestamp;return this;};this.unsetData=function(key){if(typeof this._data[key]!='undefined')
...
return this;}
this.setData(data);};var ChangeOrgApiPetition=function(client){this._authorization=null;this._callback=null;this._client=null;this._endpoints=['/v1/petitions/:petition_id/signatures','/v1/petitions/:petition_id/signatures','/v1/petitions/:petition_id/signatures/recent','/v1/petitions/:petition_id/targets','/v1/petitions/:petition_id/reasons','/v1/petitions/:petition_id/updates',];this._getDefaults=function(){return{};};this.addSignature=function(data,callback){if(typeof data.auth_key=='undefined')
...
return false;return ChangeOrgApiUtils.bind(this._endpoints[index],data);};this.getSignatures=function(data,callback){var request=new ChangeOrgApiRequest(this.getClient()).setMethod('GET').addData(data).setEndpoint(this.getEndpoint(1,data)).setSignatureRequiredFlag(false);if(callback)
request.setOnSuccess(callback);else if(this._callback)
request.setOnSuccess(this._callback);request.send();return this;};this.getRecentSignatures=function(data,callback){var request=new ChangeOrgApiRequest(this.getClient()).setMethod('GET').addData(data).setEndpoint(this.getEndpoint(2,data)).setSignatureRequiredFlag(false);if(callback)
request.setOnSuccess(callback);else if(this._callback)
request.setOnSuccess(this._callback);request.send();};this.getReasons=function(data,callback){var request=new ChangeOrgApiRequest(this.getClient()).setMethod('GET').addData(data).setEndpoint(this.getEndpoint(4,data)).setSignatureRequiredFlag(false);if(callback)
request.setOnSuccess(callback);else if(this._callback)
request.setOnSuccess(this._callback);request.send();return this;};this.getTargets=function(data,callback){var request=new ChangeOrgApiRequest(this.getClient()).setMethod('GET').addData(data).setEndpoint(this.getEndpoint(3,data)).setSignatureRequiredFlag(false);if(callback)
request.setOnSuccess(callback);else if(this._callback)
request.setOnSuccess(this._callback);request.send();return this;};this.getUpdates=function(data,callback){var request=new ChangeOrgApiRequest(this.getClient()).setMethod('GET').addData(data).setEndpoint(this.getEndpoint(5,data)).setSignatureRequiredFlag(false);if(callback)
request.setOnSuccess(callback);else if(this._callback)
...
this.setClient(client);};var ChangeOrgApiPetitionAuthorization=function(client){this._authorizationCallback=ChangeOrgApiUtils.lambda;this._client=null;this._connection=null;this._data={};this._endpoint='/v1/petitions/:petition_id/auth_keys';this._petition_id='';this._getDefaults=function(){return{callback_endpoint:'',requester_email:'',source:'',source_description:''};};this.authorize=function(callback){this.setCallback(callback);var request=new ChangeOrgApiRequest(this._client);request.addData(this._data).setMethod('POST').setEndpoint(ChangeOrgApiUtils.bind(this._endpoint,this._petition_id)).setSignatureAuthKeyRequiredFlag(false).setOnSuccess(this._authorizationCallback);request.send();return this;};this.getCallbackEndpoint=function(){return this._data.callback_endpoint;};this.getClient=function(){return this._client;};this.getEndpoint=function(data){return ChangeOrgApiUtils.bind(this._endpoint,data);};this.getRequesterEmail=function(){return this._data.requester_email;};this.getSource=function(){return this._data.source;};this.getSourceDescription=function(){return this._data.source_description;};this.setCallback=function(callback){if(typeof callback=='function')
