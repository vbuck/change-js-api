...
return this;};this.addSignature=function(clear){try{if(typeof this._data.rsig=='undefined'||!this._data.rsig.length){var body=[],signature='';for(var key in this._data){if(key!='rsig')
...
request.setOnSuccess(callback);else if(this._callback)
request.setOnSuccess(this._callback);request.send();return this;};this.getPetitionId=function(data,callback){if(typeof data=='string')
